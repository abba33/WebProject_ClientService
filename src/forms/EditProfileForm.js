...
const EditProfileForm = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await axios.get('https://webproject-authenticationservice.onrender.com/profile', {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put('https://webproject-authenticationservice.onrender.com/profile', formData, {
        headers: {
          Authorization: `Bearer ${authState.token}`,
        },
      });
