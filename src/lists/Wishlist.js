  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const profileResponse = await fetch(`https://webproject-authenticationservice.onrender.com/profile`, {
          method: 'GET',
          headers: {
        ...
        const wishlistDetails = await Promise.all(
          wishlistIds.map(async (id) => {
            ...
            const itemResponse = await fetch(`https://webproject-authenticationservice.onrender.com/${id}`, {
              method: 'GET',
              headers: {
